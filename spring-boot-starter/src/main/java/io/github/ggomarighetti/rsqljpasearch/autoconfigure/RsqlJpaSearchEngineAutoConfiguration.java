...
import io.github.ggomarighetti.rsqljpasearch.rsql.backend.perplexhub.PerplexhubRsqlBackendAdapter;
import io.github.ggomarighetti.rsqljpasearch.rsql.backend.perplexhub.PerplexhubRsqlBackendOptions;
...
@ConditionalOnProperty(prefix = "rsql.jpa.search.rsql", name = "enabled", havingValue = "true", matchIfMissing = true)
class RsqlJpaSearchEngineAutoConfiguration {
    @Bean
    ...
    @Bean
    @ConditionalOnMissingBean
    public PerplexhubRsqlBackendOptions perplexhubRsqlBackendOptions(RsqlJpaSearchProperties properties) {
        RsqlJpaSearchProperties.Rsql.Perplexhub perplexhub = properties.getRsql().getPerplexhub();
