...
class ArchitectureRulesTest {
    ...
    private final JavaClasses classes =
            new ClassFileImporter()
                    ...
                    .importPackages("io.github.ggomarighetti.rsqljpasearch");
    ...
    void productionModulesAreInternallyAcyclic() {
        ...
        for (String module : PRODUCT_MODULES) {
            ...
            slices().matching("io.github.ggomarighetti.rsqljpasearch.(*)..")
    ...
    void capabilitiesDoNotDependOnDefinitionComposition() {
        noClasses().that().resideInAnyPackage(
                ...
                .check(classes);
        noClasses().that().resideInAPackage("io.github.ggomarighetti.rsqljpasearch.validation..")
                .should().dependOnClassesThat().resideInAPackage("..definition..")
                .check(classes);
    }
