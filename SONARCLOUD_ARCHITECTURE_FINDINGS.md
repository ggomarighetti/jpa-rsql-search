...
SonarCloud del PR #26 confirma `architectureCoverage = 100`,
`numStructuralIssues = 0`, `Misplaced = 0`, `Disallowed = 0`, `Tangles = 0`,
`Weak tangles = 0` y `Split responsibilities = 0`. Sonar conserva
`numOversizeNodes = 3` como metrica estadistica dinamica del grafo, no como
issue estructural pendiente.
